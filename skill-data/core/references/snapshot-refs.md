...
# Fill email input
web-action fill @e10 "user@example.com"

# Fill password
web-action fill @e11 "password123"

# Submit the form
web-action click @e12
```
...
web-action snapshot -i          # Get refs first
web-action click @e1            # Use ref

# WRONG
web-action open https://example.com
web-action click @e1            # Ref doesn't exist yet!
```

### 2. Re-Snapshot After Navigation

```bash
web-action click @e5            # Navigates to new page
web-action snapshot -i          # Get new refs
web-action click @e1            # Use new refs
```

### 3. Re-Snapshot After Dynamic Changes

```bash
web-action click @e1            # Opens dropdown
web-action snapshot -i          # See dropdown items
web-action click @e7            # Select item
```
