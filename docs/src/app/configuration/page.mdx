...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>WEB_ACTION_AUTOSAVE_INTERVAL_MS</code></td><td>Minimum ms between periodic session autosaves while the browser is open. <code>0</code> saves only on close.</td><td><code>30000</code></td></tr>
